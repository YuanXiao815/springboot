(function($){
	...
	$.extend($.tzPageRenderers.defaultRenderer.prototype, {
		...
		getLinks:function(current_page, eventHandler,psize) {
			...
			if(this.opts.showGo)fragment.append("<a href='javascript:void(0);'  style='float:left;'>鍏�label class='tmui_page_itemcount'>"+this.maxentries+"</label>鏉�/a>&nbsp;<a href='javascript:void(0);' title='璇疯緭鍏ュ叾浠栭〉鐮� style='' class='tm_go'>GO</a><input type='text' title='璇疯緭鍏ュ叾浠栭〉鐮� class='tm_number' value='"+proxySzie+"' id='tm_pagego'/>");
			return fragment;
	...
	$.fn.tzPage = function(maxentries, opts){
		...
		function selectPage(new_current_page) {
			...
			links.appendTo(containers);
			 /*$(".tm_number").attr("title", " 璇疯緭鍏ユ暟瀛�..").on("keydown",
			    function(e) {
			        return true;
			    });*/
